...
export interface HTMLTemplateAttributes<I extends Record<string, {}>>
  extends Pick<AllAttributes, "shadowrootmode">,
    DataGlobalAttributes,
    GlobalEvents<
...
export interface HTMLElements<I extends {} = {}> {
  ...
  // Hiding the `param` element from the list, because its has been deprecated,
  // and it's tagname isn't compatible with TypeScript's `HTMLElementTagNameMap`.
  ...
  // Hiding the `rb` element from the list, because its has been deprecated,
  // and it's tagname isn't compatible with TypeScript's `HTMLElementTagNameMap`.
  ...
  /**
   * The search element is a container representing the parts of the document or application with form controls or other content related to performing a search or filtering operation.
   *
   * [MDN Reference] {@link https://developer.mozilla.org/docs/Web/HTML/Element/search} */
