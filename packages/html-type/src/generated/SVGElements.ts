...
export interface SVGElements<I extends {} = {}> {
  ...
  // Hiding the `discard` element from the list, because its existence is not questionable.
  // The MDN reference is no longer available, and it's tagname isn't compatible with TypeScript's `SVGElementTagNameMap`.
